...
const LEVEL_LABELS: Record<Metric, string[]> = {
  "Cryptography": [
...
const IBM_Mainframe = [
  "Never touched code", "Hello World scripts", "Basic COBOL/JCL", "Batch job processing", "Database integration",
  "System administration", "Performance tuning", "Legacy modernization", "Architecture design", "Mainframe wizard"
];

// Assign IBM Mainframe labels to Coding
LEVEL_LABELS.Coding = IBM_Mainframe;
type Submission = {
                ...
                <div style={{ display:"flex", gap:6, flexWrap:"wrap" }}>
                  {Array.from({ length: 10 }).map((_, idx) => (
                    <div
                      ...
                      title={`${LEVEL_LABELS[m]?.[idx] ?? `Level ${idx+1}`} (Level ${idx+1})`}
                      style={{
